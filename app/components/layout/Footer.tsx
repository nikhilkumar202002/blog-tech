      ...
      <div className="container py-12 lg:py-16">
        <div className="grid gap-12 lg:grid-cols-[1.25fr_0.9fr_0.9fr_0.9fr_0.9fr] lg:gap-10">
          <div className="max-w-[320px]">
            ...
            <div className="mt-16 space-y-1 text-[18px] font-medium leading-7">
              <p>
          ...
          {footerColumns.map((column) => (
            <div key={column.title}>
              <h3 className="text-[22px] font-semibold leading-7">{column.title}</h3>
        ...
        <div className="mt-14 flex flex-col gap-8 lg:mt-12 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-col gap-4 text-[15px] text-white/85 lg:items-end">
