    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="container">
        ...
        <div className="relative mt-14 lg:mt-16">
          <div className="absolute left-[6%] right-[6%] top-[16px] hidden h-[4px] rounded-full bg-[#B65A0F] lg:block" />

          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-6">
            {steps.map((step) => (
              <div
                key={step.title}
                className="relative rounded-[22px] border border-[#E0E0E0] bg-white px-5 pb-5 pt-9 text-left shadow-none sm:px-6 sm:pb-6 sm:pt-10"
              >
                <div className="absolute left-1/2 top-[2px] hidden h-5 w-5 -translate-x-1/2 rounded-full bg-[#B65A0F] ring-4 ring-white lg:block" />
